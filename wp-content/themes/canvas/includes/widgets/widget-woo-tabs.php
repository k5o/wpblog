...
class Woo_Tabs extends WP_Widget {
   ...
   function form($instance) {                
	   ...
	   <p>
	       <input id="<?php echo $this->get_field_id('latest'); ?>" name="<?php echo $this->get_field_name('latest'); ?>" type="checkbox" <?php if($latest == 'on') echo 'checked'; ?>"><?php _e('Latest', 'woothemes'); ?></input>
	   </p>
	   <p>

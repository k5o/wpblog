		...
		<?php } else { ?>    
			...
			<?php if ( get_next_posts_link() || get_previous_posts_link() ) { ?>
	            ...
	            <div class="nav-entries">
	                <div class="nav-prev fl"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'woothemes' ) ); ?></div>
	                <div class="nav-next fr"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'woothemes' ) ); ?></div>
	                <div class="fix"></div>
	            </div>	
...
if (!function_exists('woo_post_meta')) {
	function woo_post_meta( $is_tumblog = false, $post_id = 0 ) {
?>
<p class="post-meta">
    <?php if ( get_option('woo_disable_post_meta_author') <> "true" ) { ?><span class="post-author"><span class="small"><?php _e('by', 'woothemes') ?></span> <?php the_author_posts_link(); ?></span><?php } ?>
    <?php if ( get_option('woo_disable_post_meta_date') <> "true" ) { ?><span class="post-date"><span class="small"><?php _e('on', 'woothemes') ?></span> <?php the_time(get_option( 'date_format' )); ?></span><?php } ?>
    <?php if ( get_option('woo_disable_post_meta_cat') <> "true" ) { ?><span class="post-category"><span class="small"><?php _e('in', 'woothemes') ?></span> <?php if ($is_tumblog) { woo_tumblog_taxonomy_link($post_id); } else { the_category(', '); } ?></span><?php } ?>

...
`Tweet This 1.8.3 is a small update to fix compatibility with WordPress 3.2.`
...
http://twitter.com/intent/tweet?text=Example+Post+http://example.com/?p=1234
...
If you are upgrading from Tweet This 1.8.2 or older, follow these steps:
...
Go to Settings > Tweet This, click "Advanced Options," check
"Hide Tweet This block on pages," and click "Save Options."

= How do I hide Tweet This on RSS feeds? =

Go to Settings > Tweet This, click "Advanced Options," check
"Hide Tweet This block on all feeds," and click "Save Options."

= How do I position the Tweet This links before posts? =

Go to Settings > Tweet This, click "Advanced Options," check "Insert Tweet This
block before content," uncheck "Insert Tweet This block after content" (unless
you want the links appearing in both places), and click "Save Options."
...
= Tweet This To-Do List [32 Items] =
...
= 1.8.2 =
Nonessential update making some small upgrades.

= 1.8.1 =
Bugfix release for Twitter "Snowflake" status IDs.
